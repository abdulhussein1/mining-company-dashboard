...
import FUEL_AND_ENERGY_THREE from './Constants/FuelAndEnergyThreeConstant';

const ScopeFifthIndex = ({ activeScope }) => {
  ...
  const allTabsLists = [
    [
      { s_id: 34, s_data: FUEL_AND_ENERGY_ONE, s_name: 'Withdrawals' },
      { s_id: 35, s_data: FUEL_AND_ENERGY_TWO, s_name: 'Discharges' },
      {
        s_id: 36, s_data: FUEL_AND_ENERGY_THREE, s_name: 'Lossess', s_check: 'check',
      },
    ],
  ];
...
ScopeFifthIndex.propTypes = {
  activeScope: PropTypes.string.isRequired,
};

export default ScopeFifthIndex;
