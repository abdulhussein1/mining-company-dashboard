...
const ScopeThirdIndex = ({ activeScope }) => {
  ...
  const allTabsLists = [
    ...
    [{ s_id: 12, s_data: UPSTREAM_TRANSPORT_ONE, s_name: 'Transportation Method - 1' }, { s_id: 13, s_data: UPSTREAM_TRANSPORT_TWO, s_name: 'Transportation Method - 2' }, { s_id: 14, s_data: UPSTREAM_TRANSPORT_THREE, s_name: 'Transportation Method - 3' }],
    [{ s_id: 18, s_data: WASTE_GENERATED }],
    [{ s_id: 19, s_data: BUSINESS_TRAVEL }],
    [{ s_id: 20, s_data: EMPLOYEE_COMUTING_ONE, s_name: 'Employee Commuting 1' }, { s_id: 21, s_data: EMPLOYEE_COMUTING_TWO, s_name: 'Employee Commuting 2' }],
    [{ s_id: 22, s_data: UPSTREAM_LEASED }],
    [{ s_id: 15, s_data: DOWNSTREAM_TRANSPORT_ONE, s_name: 'Transportation Method - 1' }, { s_id: 16, s_data: DOWNSTREAM_TRANSPORT_TWO, s_name: 'Transportation Method - 2' }, { s_id: 17, s_data: DOWNSTREAM_TRANSPORT_THREE, s_name: 'Transportation Method - 3' }],
